...
public final class AtrUtils {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (line.startsWith("#") || line.trim().length() == 0) { // comment ^#/ empty line ^$/
                    ...
                    currentATR = StringUtils.Companion.deleteWhitespace(line.toUpperCase());
                } else {
    ...
    public static final Collection<String> getDescription(final String pAtr) {
        ...
        if (StringUtils.Companion.isNotBlank(pAtr)) {
            String val = StringUtils.Companion.deleteWhitespace(pAtr);
